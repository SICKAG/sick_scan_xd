...
//
// Created by michael on 7/10/18.
//

#ifndef SICK_SCAN_RADAR_OBJECT_MARKER_H
...
public:
    ...
    void setPaletteUsed(bool paletteUsed)
      {
      RadarObjectMarkerCfg::paletteUsed = paletteUsed;
      }

    const GnuPlotPalette &getGnuPlotPalette() const
      {
      return gnuPlotPalette;
      }

    void setGnuPlotPalette(const GnuPlotPalette &gnuPlotPalette)
      {
      RadarObjectMarkerCfg::gnuPlotPalette = gnuPlotPalette;
      }
    ...
    void setPaletteName(const std::string &paletteName)
            {
            RadarObjectMarkerCfg::paletteName = paletteName;
            }
    double getPaletteMaxAmpl() const
      {
      return paletteMaxAmpl;
      }

    void setPaletteMaxAmpl(double paletteMaxAmpl)
      {
      RadarObjectMarkerCfg::paletteMaxAmpl = paletteMaxAmpl;
      }

    double getPaletteMinAmpl() const
      {
      return paletteMinAmpl;
      }

    void setPaletteMinAmpl(double paletteMinAmpl)
      {
      RadarObjectMarkerCfg::paletteMinAmpl = paletteMinAmpl;
      }
...
#endif //SICK_SCAN_RADAR_OBJECT_MARKER_H
