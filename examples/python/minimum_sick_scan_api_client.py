# Minimalisitic usage example for sick_scan_api
...
def pyCustomizedPointCloudMsgCb(api_handle, msg):
    print("Python PointCloudMsgCb: {} x {} pointcloud message received".format(msg.contents.width, msg.contents.height)) # data processing to be done
