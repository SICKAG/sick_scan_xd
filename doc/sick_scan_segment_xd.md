...
* The pointcloud on topic `/cloud_fullframe` collects all segments for a complete 360 degree full scan (360 degree for multiScan100, 270 degree for picoscan100).
...
2. missing scandata after collecting the msgpack data for a full scan (360 degree for multiScan100, 270 degree for picoScan100)
