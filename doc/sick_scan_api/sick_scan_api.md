...
./sick_scan_xd_api_test ../sick_scan_xd/launch/sick_tim_7xx.launch hostname:=192.168.0.1
```
On Windows, run e.g.
```
cd .\build
set PATH=.;.\Debug;%PATH%
.\Debug\sick_scan_xd_api_test.exe ../launch/sick_lms_5xx.launch hostname:=192.168.0.1
```
