...
struct SickScanExitSrvResponse_
{
  ...
  typedef boost::shared_ptr< ::sick_scan_xd::SickScanExitSrvResponse_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::sick_scan_xd::SickScanExitSrvResponse_<ContainerAllocator> const> ConstPtr;

}; // struct SickScanExitSrvResponse_

typedef ::sick_scan_xd::SickScanExitSrvResponse_<std::allocator<void> > SickScanExitSrvResponse;

typedef boost::shared_ptr< ::sick_scan_xd::SickScanExitSrvResponse > SickScanExitSrvResponsePtr;
typedef boost::shared_ptr< ::sick_scan_xd::SickScanExitSrvResponse const> SickScanExitSrvResponseConstPtr;
...
{
ros::message_operations::Printer< ::sick_scan_xd::SickScanExitSrvResponse_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
struct MD5Sum< ::sick_scan_xd::SickScanExitSrvResponse_<ContainerAllocator> >
{
  ...
  static const char* value(const ::sick_scan_xd::SickScanExitSrvResponse_<ContainerAllocator>&) { return value(); }
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::sick_scan_xd::SickScanExitSrvResponse_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::sick_scan_xd::SickScanExitSrvResponse_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::sick_scan_xd::SickScanExitSrvResponse_<ContainerAllocator>& v)
  {
    s << indent << "success: ";
