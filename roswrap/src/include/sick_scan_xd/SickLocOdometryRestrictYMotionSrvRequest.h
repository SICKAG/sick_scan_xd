...
struct SickLocOdometryRestrictYMotionSrvRequest_
{
  ...
  typedef std::shared_ptr< ::sick_scan_xd::SickLocOdometryRestrictYMotionSrvRequest_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::sick_scan_xd::SickLocOdometryRestrictYMotionSrvRequest_<ContainerAllocator> const> ConstPtr;
...
typedef std::shared_ptr< ::sick_scan_xd::SickLocOdometryRestrictYMotionSrvRequest > SickLocOdometryRestrictYMotionSrvRequestPtr;
typedef std::shared_ptr< ::sick_scan_xd::SickLocOdometryRestrictYMotionSrvRequest const> SickLocOdometryRestrictYMotionSrvRequestConstPtr;
...
{
ros::message_operations::Printer< ::sick_scan_xd::SickLocOdometryRestrictYMotionSrvRequest_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
struct MD5Sum< ::sick_scan_xd::SickLocOdometryRestrictYMotionSrvRequest_<ContainerAllocator> >
{
  ...
  static const char* value(const ::sick_scan_xd::SickLocOdometryRestrictYMotionSrvRequest_<ContainerAllocator>&) { return value(); }
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::sick_scan_xd::SickLocOdometryRestrictYMotionSrvRequest_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::sick_scan_xd::SickLocOdometryRestrictYMotionSrvRequest_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream&, const std::string&, const ::sick_scan_xd::SickLocOdometryRestrictYMotionSrvRequest_<ContainerAllocator>&)
  {}
};
