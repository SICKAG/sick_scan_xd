...
struct SickLocSetRingBufferRecordingActiveSrvRequest_
{
  ...
  typedef std::shared_ptr< ::sick_scan_xd::SickLocSetRingBufferRecordingActiveSrvRequest_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::sick_scan_xd::SickLocSetRingBufferRecordingActiveSrvRequest_<ContainerAllocator> const> ConstPtr;
...
typedef std::shared_ptr< ::sick_scan_xd::SickLocSetRingBufferRecordingActiveSrvRequest > SickLocSetRingBufferRecordingActiveSrvRequestPtr;
typedef std::shared_ptr< ::sick_scan_xd::SickLocSetRingBufferRecordingActiveSrvRequest const> SickLocSetRingBufferRecordingActiveSrvRequestConstPtr;
...
{
ros::message_operations::Printer< ::sick_scan_xd::SickLocSetRingBufferRecordingActiveSrvRequest_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
struct MD5Sum< ::sick_scan_xd::SickLocSetRingBufferRecordingActiveSrvRequest_<ContainerAllocator> >
{
  ...
  static const char* value(const ::sick_scan_xd::SickLocSetRingBufferRecordingActiveSrvRequest_<ContainerAllocator>&) { return value(); }
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::sick_scan_xd::SickLocSetRingBufferRecordingActiveSrvRequest_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::sick_scan_xd::SickLocSetRingBufferRecordingActiveSrvRequest_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::sick_scan_xd::SickLocSetRingBufferRecordingActiveSrvRequest_<ContainerAllocator>& v)
  {
    s << indent << "active: ";
