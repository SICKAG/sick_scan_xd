...
typedef std::shared_ptr< ::sick_scan_xd::SickLocMapStateSrvResponse > SickLocMapStateSrvResponsePtr;
typedef std::shared_ptr< ::sick_scan_xd::SickLocMapStateSrvResponse const> SickLocMapStateSrvResponseConstPtr;
...
{
ros::message_operations::Printer< ::sick_scan_xd::SickLocMapStateSrvResponse_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
struct MD5Sum< ::sick_scan_xd::SickLocMapStateSrvResponse_<ContainerAllocator> >
{
  ...
  static const char* value(const ::sick_scan_xd::SickLocMapStateSrvResponse_<ContainerAllocator>&) { return value(); }
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::sick_scan_xd::SickLocMapStateSrvResponse_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::sick_scan_xd::SickLocMapStateSrvResponse_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::sick_scan_xd::SickLocMapStateSrvResponse_<ContainerAllocator>& v)
  {
    s << indent << "mapstate: ";
