...
struct SickLocIsSystemReadySrvRequest_
{
  ...
  typedef std::shared_ptr< ::sick_scan_xd::SickLocIsSystemReadySrvRequest_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::sick_scan_xd::SickLocIsSystemReadySrvRequest_<ContainerAllocator> const> ConstPtr;

}; // struct SickLocIsSystemReadySrvRequest_

typedef ::sick_scan_xd::SickLocIsSystemReadySrvRequest_<std::allocator<void> > SickLocIsSystemReadySrvRequest;

typedef std::shared_ptr< ::sick_scan_xd::SickLocIsSystemReadySrvRequest > SickLocIsSystemReadySrvRequestPtr;
typedef std::shared_ptr< ::sick_scan_xd::SickLocIsSystemReadySrvRequest const> SickLocIsSystemReadySrvRequestConstPtr;
...
{
ros::message_operations::Printer< ::sick_scan_xd::SickLocIsSystemReadySrvRequest_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
struct MD5Sum< ::sick_scan_xd::SickLocIsSystemReadySrvRequest_<ContainerAllocator> >
{
  ...
  static const char* value(const ::sick_scan_xd::SickLocIsSystemReadySrvRequest_<ContainerAllocator>&) { return value(); }
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::sick_scan_xd::SickLocIsSystemReadySrvRequest_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::sick_scan_xd::SickLocIsSystemReadySrvRequest_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream&, const std::string&, const ::sick_scan_xd::SickLocIsSystemReadySrvRequest_<ContainerAllocator>&)
  {}
};
