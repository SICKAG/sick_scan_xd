...
struct SickDevSetIMUActiveSrvRequest_
{
  ...
  typedef std::shared_ptr< ::sick_scan_xd::SickDevSetIMUActiveSrvRequest_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::sick_scan_xd::SickDevSetIMUActiveSrvRequest_<ContainerAllocator> const> ConstPtr;

}; // struct SickDevSetIMUActiveSrvRequest_

typedef ::sick_scan_xd::SickDevSetIMUActiveSrvRequest_<std::allocator<void> > SickDevSetIMUActiveSrvRequest;

typedef std::shared_ptr< ::sick_scan_xd::SickDevSetIMUActiveSrvRequest > SickDevSetIMUActiveSrvRequestPtr;
typedef std::shared_ptr< ::sick_scan_xd::SickDevSetIMUActiveSrvRequest const> SickDevSetIMUActiveSrvRequestConstPtr;
...
{
ros::message_operations::Printer< ::sick_scan_xd::SickDevSetIMUActiveSrvRequest_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
struct MD5Sum< ::sick_scan_xd::SickDevSetIMUActiveSrvRequest_<ContainerAllocator> >
{
  ...
  static const char* value(const ::sick_scan_xd::SickDevSetIMUActiveSrvRequest_<ContainerAllocator>&) { return value(); }
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::sick_scan_xd::SickDevSetIMUActiveSrvRequest_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::sick_scan_xd::SickDevSetIMUActiveSrvRequest_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::sick_scan_xd::SickDevSetIMUActiveSrvRequest_<ContainerAllocator>& v)
  {
    s << indent << "active: ";
