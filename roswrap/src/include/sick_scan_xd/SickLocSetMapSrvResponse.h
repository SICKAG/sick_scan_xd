...
struct SickLocSetMapSrvResponse_
{
  ...
  typedef std::shared_ptr< ::sick_scan_xd::SickLocSetMapSrvResponse_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::sick_scan_xd::SickLocSetMapSrvResponse_<ContainerAllocator> const> ConstPtr;

}; // struct SickLocSetMapSrvResponse_

typedef ::sick_scan_xd::SickLocSetMapSrvResponse_<std::allocator<void> > SickLocSetMapSrvResponse;

typedef std::shared_ptr< ::sick_scan_xd::SickLocSetMapSrvResponse > SickLocSetMapSrvResponsePtr;
typedef std::shared_ptr< ::sick_scan_xd::SickLocSetMapSrvResponse const> SickLocSetMapSrvResponseConstPtr;
...
{
ros::message_operations::Printer< ::sick_scan_xd::SickLocSetMapSrvResponse_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
struct MD5Sum< ::sick_scan_xd::SickLocSetMapSrvResponse_<ContainerAllocator> >
{
  ...
  static const char* value(const ::sick_scan_xd::SickLocSetMapSrvResponse_<ContainerAllocator>&) { return value(); }
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::sick_scan_xd::SickLocSetMapSrvResponse_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::sick_scan_xd::SickLocSetMapSrvResponse_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::sick_scan_xd::SickLocSetMapSrvResponse_<ContainerAllocator>& v)
  {
    s << indent << "set: ";
