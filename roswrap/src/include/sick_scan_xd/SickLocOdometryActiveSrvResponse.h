...
struct SickLocOdometryActiveSrvResponse_
{
  ...
  typedef std::shared_ptr< ::sick_scan_xd::SickLocOdometryActiveSrvResponse_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::sick_scan_xd::SickLocOdometryActiveSrvResponse_<ContainerAllocator> const> ConstPtr;

}; // struct SickLocOdometryActiveSrvResponse_

typedef ::sick_scan_xd::SickLocOdometryActiveSrvResponse_<std::allocator<void> > SickLocOdometryActiveSrvResponse;

typedef std::shared_ptr< ::sick_scan_xd::SickLocOdometryActiveSrvResponse > SickLocOdometryActiveSrvResponsePtr;
typedef std::shared_ptr< ::sick_scan_xd::SickLocOdometryActiveSrvResponse const> SickLocOdometryActiveSrvResponseConstPtr;
...
{
ros::message_operations::Printer< ::sick_scan_xd::SickLocOdometryActiveSrvResponse_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
struct MD5Sum< ::sick_scan_xd::SickLocOdometryActiveSrvResponse_<ContainerAllocator> >
{
  ...
  static const char* value(const ::sick_scan_xd::SickLocOdometryActiveSrvResponse_<ContainerAllocator>&) { return value(); }
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::sick_scan_xd::SickLocOdometryActiveSrvResponse_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::sick_scan_xd::SickLocOdometryActiveSrvResponse_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::sick_scan_xd::SickLocOdometryActiveSrvResponse_<ContainerAllocator>& v)
  {
    s << indent << "active: ";
