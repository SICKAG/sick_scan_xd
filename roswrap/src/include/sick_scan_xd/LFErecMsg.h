...
#include <sick_scan_xd/LFErecFieldMsg.h>
...
struct LFErecMsg_
{
  ...
  typedef std::shared_ptr< ::sick_scan_xd::LFErecMsg_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::sick_scan_xd::LFErecMsg_<ContainerAllocator> const> ConstPtr;

}; // struct LFErecMsg_

typedef ::sick_scan_xd::LFErecMsg_<std::allocator<void> > LFErecMsg;

typedef std::shared_ptr< ::sick_scan_xd::LFErecMsg > LFErecMsgPtr;
typedef std::shared_ptr< ::sick_scan_xd::LFErecMsg const> LFErecMsgConstPtr;
...
{
ros::message_operations::Printer< ::sick_scan_xd::LFErecMsg_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
struct MD5Sum< ::sick_scan_xd::LFErecMsg_<ContainerAllocator> >
{
  ...
  static const char* value(const ::sick_scan_xd::LFErecMsg_<ContainerAllocator>&) { return value(); }
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::sick_scan_xd::LFErecMsg_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::sick_scan_xd::LFErecMsg_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::sick_scan_xd::LFErecMsg_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
    ...
    for (size_t i = 0; i < v.fields.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::sick_scan_xd::LFErecFieldMsg_<ContainerAllocator> >::stream(s, indent + "    ", v.fields[i]);
    }
  }
};
