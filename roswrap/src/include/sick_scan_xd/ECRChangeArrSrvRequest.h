...
struct ECRChangeArrSrvRequest_
{
  ...
  typedef std::shared_ptr< ::sick_scan_xd::ECRChangeArrSrvRequest_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::sick_scan_xd::ECRChangeArrSrvRequest_<ContainerAllocator> const> ConstPtr;

}; // struct ECRChangeArrSrvRequest_

typedef ::sick_scan_xd::ECRChangeArrSrvRequest_<std::allocator<void> > ECRChangeArrSrvRequest;

typedef std::shared_ptr< ::sick_scan_xd::ECRChangeArrSrvRequest > ECRChangeArrSrvRequestPtr;
typedef std::shared_ptr< ::sick_scan_xd::ECRChangeArrSrvRequest const> ECRChangeArrSrvRequestConstPtr;
...
{
ros::message_operations::Printer< ::sick_scan_xd::ECRChangeArrSrvRequest_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
struct MD5Sum< ::sick_scan_xd::ECRChangeArrSrvRequest_<ContainerAllocator> >
{
  ...
  static const char* value(const ::sick_scan_xd::ECRChangeArrSrvRequest_<ContainerAllocator>&) { return value(); }
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::sick_scan_xd::ECRChangeArrSrvRequest_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::sick_scan_xd::ECRChangeArrSrvRequest_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::sick_scan_xd::ECRChangeArrSrvRequest_<ContainerAllocator>& v)
  {
    s << indent << "active: ";
