...
struct LFErecFieldMsg_
{
  ...
  typedef std::shared_ptr< ::sick_scan_xd::LFErecFieldMsg_<ContainerAllocator> const> ConstPtr;

}; // struct LFErecFieldMsg_

typedef ::sick_scan_xd::LFErecFieldMsg_<std::allocator<void> > LFErecFieldMsg;

typedef std::shared_ptr< ::sick_scan_xd::LFErecFieldMsg > LFErecFieldMsgPtr;
typedef std::shared_ptr< ::sick_scan_xd::LFErecFieldMsg const> LFErecFieldMsgConstPtr;
...
{
ros::message_operations::Printer< ::sick_scan_xd::LFErecFieldMsg_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
struct MD5Sum< ::sick_scan_xd::LFErecFieldMsg_<ContainerAllocator> >
{
  ...
  static const char* value(const ::sick_scan_xd::LFErecFieldMsg_<ContainerAllocator>&) { return value(); }
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::sick_scan_xd::LFErecFieldMsg_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::sick_scan_xd::LFErecFieldMsg_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::sick_scan_xd::LFErecFieldMsg_<ContainerAllocator>& v)
  {
