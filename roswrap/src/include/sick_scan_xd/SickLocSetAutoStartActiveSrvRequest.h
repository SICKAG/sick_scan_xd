...
struct SickLocSetAutoStartActiveSrvRequest_
{
  ...
  typedef std::shared_ptr< ::sick_scan_xd::SickLocSetAutoStartActiveSrvRequest_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::sick_scan_xd::SickLocSetAutoStartActiveSrvRequest_<ContainerAllocator> const> ConstPtr;

}; // struct SickLocSetAutoStartActiveSrvRequest_

typedef ::sick_scan_xd::SickLocSetAutoStartActiveSrvRequest_<std::allocator<void> > SickLocSetAutoStartActiveSrvRequest;

typedef std::shared_ptr< ::sick_scan_xd::SickLocSetAutoStartActiveSrvRequest > SickLocSetAutoStartActiveSrvRequestPtr;
typedef std::shared_ptr< ::sick_scan_xd::SickLocSetAutoStartActiveSrvRequest const> SickLocSetAutoStartActiveSrvRequestConstPtr;
...
{
ros::message_operations::Printer< ::sick_scan_xd::SickLocSetAutoStartActiveSrvRequest_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
struct MD5Sum< ::sick_scan_xd::SickLocSetAutoStartActiveSrvRequest_<ContainerAllocator> >
{
  ...
  static const char* value(const ::sick_scan_xd::SickLocSetAutoStartActiveSrvRequest_<ContainerAllocator>&) { return value(); }
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::sick_scan_xd::SickLocSetAutoStartActiveSrvRequest_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::sick_scan_xd::SickLocSetAutoStartActiveSrvRequest_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::sick_scan_xd::SickLocSetAutoStartActiveSrvRequest_<ContainerAllocator>& v)
  {
    s << indent << "active: ";
