...
struct SickLocSetResultPortSrvResponse_
{
  ...
  typedef std::shared_ptr< ::sick_scan_xd::SickLocSetResultPortSrvResponse_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::sick_scan_xd::SickLocSetResultPortSrvResponse_<ContainerAllocator> const> ConstPtr;

}; // struct SickLocSetResultPortSrvResponse_

typedef ::sick_scan_xd::SickLocSetResultPortSrvResponse_<std::allocator<void> > SickLocSetResultPortSrvResponse;

typedef std::shared_ptr< ::sick_scan_xd::SickLocSetResultPortSrvResponse > SickLocSetResultPortSrvResponsePtr;
typedef std::shared_ptr< ::sick_scan_xd::SickLocSetResultPortSrvResponse const> SickLocSetResultPortSrvResponseConstPtr;
...
{
ros::message_operations::Printer< ::sick_scan_xd::SickLocSetResultPortSrvResponse_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
struct MD5Sum< ::sick_scan_xd::SickLocSetResultPortSrvResponse_<ContainerAllocator> >
{
  ...
  static const char* value(const ::sick_scan_xd::SickLocSetResultPortSrvResponse_<ContainerAllocator>&) { return value(); }
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::sick_scan_xd::SickLocSetResultPortSrvResponse_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::sick_scan_xd::SickLocSetResultPortSrvResponse_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::sick_scan_xd::SickLocSetResultPortSrvResponse_<ContainerAllocator>& v)
  {
    s << indent << "success: ";
