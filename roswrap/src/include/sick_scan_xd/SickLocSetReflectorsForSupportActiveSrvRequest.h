...
struct SickLocSetReflectorsForSupportActiveSrvRequest_
{
  ...
  typedef std::shared_ptr< ::sick_scan_xd::SickLocSetReflectorsForSupportActiveSrvRequest_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::sick_scan_xd::SickLocSetReflectorsForSupportActiveSrvRequest_<ContainerAllocator> const> ConstPtr;
...
typedef std::shared_ptr< ::sick_scan_xd::SickLocSetReflectorsForSupportActiveSrvRequest > SickLocSetReflectorsForSupportActiveSrvRequestPtr;
typedef std::shared_ptr< ::sick_scan_xd::SickLocSetReflectorsForSupportActiveSrvRequest const> SickLocSetReflectorsForSupportActiveSrvRequestConstPtr;
...
{
ros::message_operations::Printer< ::sick_scan_xd::SickLocSetReflectorsForSupportActiveSrvRequest_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
struct MD5Sum< ::sick_scan_xd::SickLocSetReflectorsForSupportActiveSrvRequest_<ContainerAllocator> >
{
  ...
  static const char* value(const ::sick_scan_xd::SickLocSetReflectorsForSupportActiveSrvRequest_<ContainerAllocator>&) { return value(); }
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::sick_scan_xd::SickLocSetReflectorsForSupportActiveSrvRequest_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::sick_scan_xd::SickLocSetReflectorsForSupportActiveSrvRequest_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::sick_scan_xd::SickLocSetReflectorsForSupportActiveSrvRequest_<ContainerAllocator>& v)
  {
    s << indent << "active: ";
