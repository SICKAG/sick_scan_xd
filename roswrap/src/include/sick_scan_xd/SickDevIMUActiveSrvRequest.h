...
struct SickDevIMUActiveSrvRequest_
{
  ...
  typedef std::shared_ptr< ::sick_scan_xd::SickDevIMUActiveSrvRequest_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::sick_scan_xd::SickDevIMUActiveSrvRequest_<ContainerAllocator> const> ConstPtr;

}; // struct SickDevIMUActiveSrvRequest_

typedef ::sick_scan_xd::SickDevIMUActiveSrvRequest_<std::allocator<void> > SickDevIMUActiveSrvRequest;

typedef std::shared_ptr< ::sick_scan_xd::SickDevIMUActiveSrvRequest > SickDevIMUActiveSrvRequestPtr;
typedef std::shared_ptr< ::sick_scan_xd::SickDevIMUActiveSrvRequest const> SickDevIMUActiveSrvRequestConstPtr;
...
{
ros::message_operations::Printer< ::sick_scan_xd::SickDevIMUActiveSrvRequest_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
struct MD5Sum< ::sick_scan_xd::SickDevIMUActiveSrvRequest_<ContainerAllocator> >
{
  ...
  static const char* value(const ::sick_scan_xd::SickDevIMUActiveSrvRequest_<ContainerAllocator>&) { return value(); }
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::sick_scan_xd::SickDevIMUActiveSrvRequest_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::sick_scan_xd::SickDevIMUActiveSrvRequest_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream&, const std::string&, const ::sick_scan_xd::SickDevIMUActiveSrvRequest_<ContainerAllocator>&)
  {}
};
