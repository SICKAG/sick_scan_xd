...
struct SickLocAutoStartActiveSrvResponse_
{
  ...
  typedef std::shared_ptr< ::sick_scan_xd::SickLocAutoStartActiveSrvResponse_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::sick_scan_xd::SickLocAutoStartActiveSrvResponse_<ContainerAllocator> const> ConstPtr;

}; // struct SickLocAutoStartActiveSrvResponse_

typedef ::sick_scan_xd::SickLocAutoStartActiveSrvResponse_<std::allocator<void> > SickLocAutoStartActiveSrvResponse;

typedef std::shared_ptr< ::sick_scan_xd::SickLocAutoStartActiveSrvResponse > SickLocAutoStartActiveSrvResponsePtr;
typedef std::shared_ptr< ::sick_scan_xd::SickLocAutoStartActiveSrvResponse const> SickLocAutoStartActiveSrvResponseConstPtr;
...
{
ros::message_operations::Printer< ::sick_scan_xd::SickLocAutoStartActiveSrvResponse_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
struct MD5Sum< ::sick_scan_xd::SickLocAutoStartActiveSrvResponse_<ContainerAllocator> >
{
  ...
  static const char* value(const ::sick_scan_xd::SickLocAutoStartActiveSrvResponse_<ContainerAllocator>&) { return value(); }
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::sick_scan_xd::SickLocAutoStartActiveSrvResponse_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::sick_scan_xd::SickLocAutoStartActiveSrvResponse_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::sick_scan_xd::SickLocAutoStartActiveSrvResponse_<ContainerAllocator>& v)
  {
    s << indent << "active: ";
