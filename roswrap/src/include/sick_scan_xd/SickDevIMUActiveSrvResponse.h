...
struct SickDevIMUActiveSrvResponse_
{
  ...
  typedef std::shared_ptr< ::sick_scan_xd::SickDevIMUActiveSrvResponse_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::sick_scan_xd::SickDevIMUActiveSrvResponse_<ContainerAllocator> const> ConstPtr;

}; // struct SickDevIMUActiveSrvResponse_

typedef ::sick_scan_xd::SickDevIMUActiveSrvResponse_<std::allocator<void> > SickDevIMUActiveSrvResponse;

typedef std::shared_ptr< ::sick_scan_xd::SickDevIMUActiveSrvResponse > SickDevIMUActiveSrvResponsePtr;
typedef std::shared_ptr< ::sick_scan_xd::SickDevIMUActiveSrvResponse const> SickDevIMUActiveSrvResponseConstPtr;
...
{
ros::message_operations::Printer< ::sick_scan_xd::SickDevIMUActiveSrvResponse_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
struct MD5Sum< ::sick_scan_xd::SickDevIMUActiveSrvResponse_<ContainerAllocator> >
{
  ...
  static const char* value(const ::sick_scan_xd::SickDevIMUActiveSrvResponse_<ContainerAllocator>&) { return value(); }
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::sick_scan_xd::SickDevIMUActiveSrvResponse_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::sick_scan_xd::SickDevIMUActiveSrvResponse_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::sick_scan_xd::SickDevIMUActiveSrvResponse_<ContainerAllocator>& v)
  {
    s << indent << "active: ";
