...
struct SickLocOdometryRestrictYMotionSrvResponse_
{
  ...
  typedef std::shared_ptr< ::sick_scan_xd::SickLocOdometryRestrictYMotionSrvResponse_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::sick_scan_xd::SickLocOdometryRestrictYMotionSrvResponse_<ContainerAllocator> const> ConstPtr;
...
typedef std::shared_ptr< ::sick_scan_xd::SickLocOdometryRestrictYMotionSrvResponse > SickLocOdometryRestrictYMotionSrvResponsePtr;
typedef std::shared_ptr< ::sick_scan_xd::SickLocOdometryRestrictYMotionSrvResponse const> SickLocOdometryRestrictYMotionSrvResponseConstPtr;
...
{
ros::message_operations::Printer< ::sick_scan_xd::SickLocOdometryRestrictYMotionSrvResponse_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
struct MD5Sum< ::sick_scan_xd::SickLocOdometryRestrictYMotionSrvResponse_<ContainerAllocator> >
{
  ...
  static const char* value(const ::sick_scan_xd::SickLocOdometryRestrictYMotionSrvResponse_<ContainerAllocator>&) { return value(); }
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::sick_scan_xd::SickLocOdometryRestrictYMotionSrvResponse_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::sick_scan_xd::SickLocOdometryRestrictYMotionSrvResponse_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::sick_scan_xd::SickLocOdometryRestrictYMotionSrvResponse_<ContainerAllocator>& v)
  {
    s << indent << "active: ";
