...
struct SickLocResultPortTestcaseMsg_
{
  ...
  _binary_data_type binary_data;
   ...
   typedef  ::sick_scan::SickLocResultPortTelegramMsg_<ContainerAllocator>  _telegram_msg_type;
...
std::ostream& operator<<(std::ostream& s, const ::sick_scan::SickLocResultPortTestcaseMsg_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::sick_scan::SickLocResultPortTestcaseMsg_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::sick_scan::SickLocResultPortTestcaseMsg_<ContainerAllocator1> & lhs, const ::sick_scan::SickLocResultPortTestcaseMsg_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::sick_scan::SickLocResultPortTestcaseMsg_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::sick_scan::SickLocResultPortTestcaseMsg_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::sick_scan::SickLocResultPortTestcaseMsg_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::sick_scan::SickLocResultPortTestcaseMsg_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sick_scan::SickLocResultPortTestcaseMsg_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sick_scan::SickLocResultPortTestcaseMsg_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::sick_scan::SickLocResultPortTestcaseMsg_<ContainerAllocator> >
{
  ...
  static const char* value(const ::sick_scan::SickLocResultPortTestcaseMsg_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x38e9c3306b5acbeaULL;
  static const uint64_t static_value2 = 0x8482510e0b314a8dULL;
};

template<class ContainerAllocator>
struct DataType< ::sick_scan::SickLocResultPortTestcaseMsg_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::sick_scan::SickLocResultPortTestcaseMsg_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::sick_scan::SickLocResultPortTestcaseMsg_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::sick_scan::SickLocResultPortTestcaseMsg_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::sick_scan::SickLocResultPortTestcaseMsg_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
    ...
    s << std::endl;
    Printer< ::sick_scan::SickLocResultPortTelegramMsg_<ContainerAllocator> >::stream(s, indent + "  ", v.telegram_msg);
  }
};
