...
struct SickDevGetLidarConfigSrvResponse_
{
  ...
  typedef boost::shared_ptr< ::sick_scan::SickDevGetLidarConfigSrvResponse_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::sick_scan::SickDevGetLidarConfigSrvResponse_<ContainerAllocator> const> ConstPtr;

}; // struct SickDevGetLidarConfigSrvResponse_

typedef ::sick_scan::SickDevGetLidarConfigSrvResponse_<std::allocator<void> > SickDevGetLidarConfigSrvResponse;

typedef boost::shared_ptr< ::sick_scan::SickDevGetLidarConfigSrvResponse > SickDevGetLidarConfigSrvResponsePtr;
typedef boost::shared_ptr< ::sick_scan::SickDevGetLidarConfigSrvResponse const> SickDevGetLidarConfigSrvResponseConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::sick_scan::SickDevGetLidarConfigSrvResponse_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::sick_scan::SickDevGetLidarConfigSrvResponse_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::sick_scan::SickDevGetLidarConfigSrvResponse_<ContainerAllocator1> & lhs, const ::sick_scan::SickDevGetLidarConfigSrvResponse_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::sick_scan::SickDevGetLidarConfigSrvResponse_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::sick_scan::SickDevGetLidarConfigSrvResponse_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::sick_scan::SickDevGetLidarConfigSrvResponse_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::sick_scan::SickDevGetLidarConfigSrvResponse_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sick_scan::SickDevGetLidarConfigSrvResponse_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sick_scan::SickDevGetLidarConfigSrvResponse_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::sick_scan::SickDevGetLidarConfigSrvResponse_<ContainerAllocator> >
{
  ...
  static const char* value(const ::sick_scan::SickDevGetLidarConfigSrvResponse_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x462ad504bef43441ULL;
  static const uint64_t static_value2 = 0x13127040feff08e1ULL;
};

template<class ContainerAllocator>
struct DataType< ::sick_scan::SickDevGetLidarConfigSrvResponse_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::sick_scan::SickDevGetLidarConfigSrvResponse_<ContainerAllocator> >
{
  static const char* value()
  {
    return "\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::sick_scan::SickDevGetLidarConfigSrvResponse_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::sick_scan::SickDevGetLidarConfigSrvResponse_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::sick_scan::SickDevGetLidarConfigSrvResponse_<ContainerAllocator>& v)
  {
    s << indent << "minrange: ";
