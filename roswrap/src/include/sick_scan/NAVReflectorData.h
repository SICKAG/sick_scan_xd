...
struct NAVReflectorData_
{
  ...
  typedef std::shared_ptr< ::sick_scan::NAVReflectorData_<ContainerAllocator> > Ptr;
  typedef std::shared_ptr< ::sick_scan::NAVReflectorData_<ContainerAllocator> const> ConstPtr;

}; // struct NAVReflectorData_

typedef ::sick_scan::NAVReflectorData_<std::allocator<void> > NAVReflectorData;

typedef std::shared_ptr< ::sick_scan::NAVReflectorData > NAVReflectorDataPtr;
typedef std::shared_ptr< ::sick_scan::NAVReflectorData const> NAVReflectorDataConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::sick_scan::NAVReflectorData_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::sick_scan::NAVReflectorData_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::sick_scan::NAVReflectorData_<ContainerAllocator1> & lhs, const ::sick_scan::NAVReflectorData_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::sick_scan::NAVReflectorData_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::sick_scan::NAVReflectorData_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::sick_scan::NAVReflectorData_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::sick_scan::NAVReflectorData_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sick_scan::NAVReflectorData_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sick_scan::NAVReflectorData_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::sick_scan::NAVReflectorData_<ContainerAllocator> >
{
  ...
  static const char* value(const ::sick_scan::NAVReflectorData_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xc834b1997d0f1a7bULL;
  static const uint64_t static_value2 = 0x5b282c13153f6e67ULL;
};

template<class ContainerAllocator>
struct DataType< ::sick_scan::NAVReflectorData_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::sick_scan::NAVReflectorData_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::sick_scan::NAVReflectorData_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::sick_scan::NAVReflectorData_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::sick_scan::NAVReflectorData_<ContainerAllocator>& v)
  {
