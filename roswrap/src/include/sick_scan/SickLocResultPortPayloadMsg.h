...
struct SickLocResultPortPayloadMsg_
{
  ...
  typedef boost::shared_ptr< ::sick_scan::SickLocResultPortPayloadMsg_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::sick_scan::SickLocResultPortPayloadMsg_<ContainerAllocator> const> ConstPtr;

}; // struct SickLocResultPortPayloadMsg_

typedef ::sick_scan::SickLocResultPortPayloadMsg_<std::allocator<void> > SickLocResultPortPayloadMsg;

typedef boost::shared_ptr< ::sick_scan::SickLocResultPortPayloadMsg > SickLocResultPortPayloadMsgPtr;
typedef boost::shared_ptr< ::sick_scan::SickLocResultPortPayloadMsg const> SickLocResultPortPayloadMsgConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::sick_scan::SickLocResultPortPayloadMsg_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::sick_scan::SickLocResultPortPayloadMsg_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::sick_scan::SickLocResultPortPayloadMsg_<ContainerAllocator1> & lhs, const ::sick_scan::SickLocResultPortPayloadMsg_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::sick_scan::SickLocResultPortPayloadMsg_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::sick_scan::SickLocResultPortPayloadMsg_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::sick_scan::SickLocResultPortPayloadMsg_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::sick_scan::SickLocResultPortPayloadMsg_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sick_scan::SickLocResultPortPayloadMsg_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sick_scan::SickLocResultPortPayloadMsg_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::sick_scan::SickLocResultPortPayloadMsg_<ContainerAllocator> >
{
  ...
  static const char* value(const ::sick_scan::SickLocResultPortPayloadMsg_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xb80aed977dece34aULL;
  static const uint64_t static_value2 = 0x3c761a1bbf1b6cecULL;
};

template<class ContainerAllocator>
struct DataType< ::sick_scan::SickLocResultPortPayloadMsg_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::sick_scan::SickLocResultPortPayloadMsg_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::sick_scan::SickLocResultPortPayloadMsg_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::sick_scan::SickLocResultPortPayloadMsg_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::sick_scan::SickLocResultPortPayloadMsg_<ContainerAllocator>& v)
  {
    s << indent << "errorcode: ";
