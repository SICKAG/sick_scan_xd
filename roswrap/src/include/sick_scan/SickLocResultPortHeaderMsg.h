...
struct SickLocResultPortHeaderMsg_
{
  ...
  typedef boost::shared_ptr< ::sick_scan::SickLocResultPortHeaderMsg_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::sick_scan::SickLocResultPortHeaderMsg_<ContainerAllocator> const> ConstPtr;

}; // struct SickLocResultPortHeaderMsg_

typedef ::sick_scan::SickLocResultPortHeaderMsg_<std::allocator<void> > SickLocResultPortHeaderMsg;

typedef boost::shared_ptr< ::sick_scan::SickLocResultPortHeaderMsg > SickLocResultPortHeaderMsgPtr;
typedef boost::shared_ptr< ::sick_scan::SickLocResultPortHeaderMsg const> SickLocResultPortHeaderMsgConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::sick_scan::SickLocResultPortHeaderMsg_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::sick_scan::SickLocResultPortHeaderMsg_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::sick_scan::SickLocResultPortHeaderMsg_<ContainerAllocator1> & lhs, const ::sick_scan::SickLocResultPortHeaderMsg_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::sick_scan::SickLocResultPortHeaderMsg_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::sick_scan::SickLocResultPortHeaderMsg_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::sick_scan::SickLocResultPortHeaderMsg_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::sick_scan::SickLocResultPortHeaderMsg_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sick_scan::SickLocResultPortHeaderMsg_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sick_scan::SickLocResultPortHeaderMsg_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::sick_scan::SickLocResultPortHeaderMsg_<ContainerAllocator> >
{
  ...
  static const char* value(const ::sick_scan::SickLocResultPortHeaderMsg_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x974a1ebc4ebbc21cULL;
  static const uint64_t static_value2 = 0x0773fa36aa0f0469ULL;
};

template<class ContainerAllocator>
struct DataType< ::sick_scan::SickLocResultPortHeaderMsg_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::sick_scan::SickLocResultPortHeaderMsg_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::sick_scan::SickLocResultPortHeaderMsg_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::sick_scan::SickLocResultPortHeaderMsg_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::sick_scan::SickLocResultPortHeaderMsg_<ContainerAllocator>& v)
  {
    s << indent << "magicword: ";
