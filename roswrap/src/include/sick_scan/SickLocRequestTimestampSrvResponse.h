...
struct SickLocRequestTimestampSrvResponse_
{
  ...
  typedef boost::shared_ptr< ::sick_scan::SickLocRequestTimestampSrvResponse_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::sick_scan::SickLocRequestTimestampSrvResponse_<ContainerAllocator> const> ConstPtr;

}; // struct SickLocRequestTimestampSrvResponse_

typedef ::sick_scan::SickLocRequestTimestampSrvResponse_<std::allocator<void> > SickLocRequestTimestampSrvResponse;

typedef boost::shared_ptr< ::sick_scan::SickLocRequestTimestampSrvResponse > SickLocRequestTimestampSrvResponsePtr;
typedef boost::shared_ptr< ::sick_scan::SickLocRequestTimestampSrvResponse const> SickLocRequestTimestampSrvResponseConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::sick_scan::SickLocRequestTimestampSrvResponse_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::sick_scan::SickLocRequestTimestampSrvResponse_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::sick_scan::SickLocRequestTimestampSrvResponse_<ContainerAllocator1> & lhs, const ::sick_scan::SickLocRequestTimestampSrvResponse_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::sick_scan::SickLocRequestTimestampSrvResponse_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::sick_scan::SickLocRequestTimestampSrvResponse_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::sick_scan::SickLocRequestTimestampSrvResponse_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::sick_scan::SickLocRequestTimestampSrvResponse_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sick_scan::SickLocRequestTimestampSrvResponse_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sick_scan::SickLocRequestTimestampSrvResponse_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::sick_scan::SickLocRequestTimestampSrvResponse_<ContainerAllocator> >
{
  ...
  static const char* value(const ::sick_scan::SickLocRequestTimestampSrvResponse_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xae8b1571bf8be63eULL;
  static const uint64_t static_value2 = 0x0bdad9873d14be2bULL;
};

template<class ContainerAllocator>
struct DataType< ::sick_scan::SickLocRequestTimestampSrvResponse_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::sick_scan::SickLocRequestTimestampSrvResponse_<ContainerAllocator> >
{
  static const char* value()
  {
    return "\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::sick_scan::SickLocRequestTimestampSrvResponse_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::sick_scan::SickLocRequestTimestampSrvResponse_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::sick_scan::SickLocRequestTimestampSrvResponse_<ContainerAllocator>& v)
  {
