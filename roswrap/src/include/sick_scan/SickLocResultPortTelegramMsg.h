...
struct SickLocResultPortTelegramMsg_
{
  ...
  _header_type header;
   ...
   typedef  ::sick_scan::SickLocResultPortHeaderMsg_<ContainerAllocator>  _telegram_header_type;
  _telegram_header_type telegram_header;

   typedef  ::sick_scan::SickLocResultPortPayloadMsg_<ContainerAllocator>  _telegram_payload_type;
  _telegram_payload_type telegram_payload;

   typedef  ::sick_scan::SickLocResultPortCrcMsg_<ContainerAllocator>  _telegram_trailer_type;
...
std::ostream& operator<<(std::ostream& s, const ::sick_scan::SickLocResultPortTelegramMsg_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::sick_scan::SickLocResultPortTelegramMsg_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::sick_scan::SickLocResultPortTelegramMsg_<ContainerAllocator1> & lhs, const ::sick_scan::SickLocResultPortTelegramMsg_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::sick_scan::SickLocResultPortTelegramMsg_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::sick_scan::SickLocResultPortTelegramMsg_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::sick_scan::SickLocResultPortTelegramMsg_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::sick_scan::SickLocResultPortTelegramMsg_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sick_scan::SickLocResultPortTelegramMsg_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sick_scan::SickLocResultPortTelegramMsg_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::sick_scan::SickLocResultPortTelegramMsg_<ContainerAllocator> >
{
  ...
  static const char* value(const ::sick_scan::SickLocResultPortTelegramMsg_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x491c7d2167f9158dULL;
  static const uint64_t static_value2 = 0xf5febcf9e822aba3ULL;
};

template<class ContainerAllocator>
struct DataType< ::sick_scan::SickLocResultPortTelegramMsg_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::sick_scan::SickLocResultPortTelegramMsg_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::sick_scan::SickLocResultPortTelegramMsg_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::sick_scan::SickLocResultPortTelegramMsg_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::sick_scan::SickLocResultPortTelegramMsg_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
    ...
    s << std::endl;
    Printer< ::sick_scan::SickLocResultPortHeaderMsg_<ContainerAllocator> >::stream(s, indent + "  ", v.telegram_header);
    s << indent << "telegram_payload: ";
    s << std::endl;
    Printer< ::sick_scan::SickLocResultPortPayloadMsg_<ContainerAllocator> >::stream(s, indent + "  ", v.telegram_payload);
    s << indent << "telegram_trailer: ";
    s << std::endl;
    Printer< ::sick_scan::SickLocResultPortCrcMsg_<ContainerAllocator> >::stream(s, indent + "  ", v.telegram_trailer);
