...
struct SickLocColaTelegramSrvResponse_
{
  ...
  typedef boost::shared_ptr< ::sick_scan::SickLocColaTelegramSrvResponse_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::sick_scan::SickLocColaTelegramSrvResponse_<ContainerAllocator> const> ConstPtr;

}; // struct SickLocColaTelegramSrvResponse_

typedef ::sick_scan::SickLocColaTelegramSrvResponse_<std::allocator<void> > SickLocColaTelegramSrvResponse;

typedef boost::shared_ptr< ::sick_scan::SickLocColaTelegramSrvResponse > SickLocColaTelegramSrvResponsePtr;
typedef boost::shared_ptr< ::sick_scan::SickLocColaTelegramSrvResponse const> SickLocColaTelegramSrvResponseConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::sick_scan::SickLocColaTelegramSrvResponse_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::sick_scan::SickLocColaTelegramSrvResponse_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::sick_scan::SickLocColaTelegramSrvResponse_<ContainerAllocator1> & lhs, const ::sick_scan::SickLocColaTelegramSrvResponse_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::sick_scan::SickLocColaTelegramSrvResponse_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::sick_scan::SickLocColaTelegramSrvResponse_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::sick_scan::SickLocColaTelegramSrvResponse_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::sick_scan::SickLocColaTelegramSrvResponse_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sick_scan::SickLocColaTelegramSrvResponse_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sick_scan::SickLocColaTelegramSrvResponse_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::sick_scan::SickLocColaTelegramSrvResponse_<ContainerAllocator> >
{
  ...
  static const char* value(const ::sick_scan::SickLocColaTelegramSrvResponse_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x4a966f9c77cc89ffULL;
  static const uint64_t static_value2 = 0xe63caaa088f93373ULL;
};

template<class ContainerAllocator>
struct DataType< ::sick_scan::SickLocColaTelegramSrvResponse_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::sick_scan::SickLocColaTelegramSrvResponse_<ContainerAllocator> >
{
  static const char* value()
  {
    return "\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::sick_scan::SickLocColaTelegramSrvResponse_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::sick_scan::SickLocColaTelegramSrvResponse_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::sick_scan::SickLocColaTelegramSrvResponse_<ContainerAllocator>& v)
  {
