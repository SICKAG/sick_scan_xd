...
struct SickDevSetLidarConfigSrvRequest_
{
  ...
  typedef boost::shared_ptr< ::sick_scan::SickDevSetLidarConfigSrvRequest_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::sick_scan::SickDevSetLidarConfigSrvRequest_<ContainerAllocator> const> ConstPtr;

}; // struct SickDevSetLidarConfigSrvRequest_

typedef ::sick_scan::SickDevSetLidarConfigSrvRequest_<std::allocator<void> > SickDevSetLidarConfigSrvRequest;

typedef boost::shared_ptr< ::sick_scan::SickDevSetLidarConfigSrvRequest > SickDevSetLidarConfigSrvRequestPtr;
typedef boost::shared_ptr< ::sick_scan::SickDevSetLidarConfigSrvRequest const> SickDevSetLidarConfigSrvRequestConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::sick_scan::SickDevSetLidarConfigSrvRequest_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::sick_scan::SickDevSetLidarConfigSrvRequest_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::sick_scan::SickDevSetLidarConfigSrvRequest_<ContainerAllocator1> & lhs, const ::sick_scan::SickDevSetLidarConfigSrvRequest_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::sick_scan::SickDevSetLidarConfigSrvRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::sick_scan::SickDevSetLidarConfigSrvRequest_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::sick_scan::SickDevSetLidarConfigSrvRequest_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::sick_scan::SickDevSetLidarConfigSrvRequest_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sick_scan::SickDevSetLidarConfigSrvRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sick_scan::SickDevSetLidarConfigSrvRequest_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::sick_scan::SickDevSetLidarConfigSrvRequest_<ContainerAllocator> >
{
  ...
  static const char* value(const ::sick_scan::SickDevSetLidarConfigSrvRequest_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xbcc8a58e8b9a5610ULL;
  static const uint64_t static_value2 = 0x0f4e9919c37f836aULL;
};

template<class ContainerAllocator>
struct DataType< ::sick_scan::SickDevSetLidarConfigSrvRequest_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::sick_scan::SickDevSetLidarConfigSrvRequest_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::sick_scan::SickDevSetLidarConfigSrvRequest_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::sick_scan::SickDevSetLidarConfigSrvRequest_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::sick_scan::SickDevSetLidarConfigSrvRequest_<ContainerAllocator>& v)
  {
    s << indent << "index: ";
