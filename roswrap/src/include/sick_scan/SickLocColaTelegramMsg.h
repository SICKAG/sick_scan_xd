...
struct SickLocColaTelegramMsg_
{
  ...
  typedef boost::shared_ptr< ::sick_scan::SickLocColaTelegramMsg_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::sick_scan::SickLocColaTelegramMsg_<ContainerAllocator> const> ConstPtr;

}; // struct SickLocColaTelegramMsg_

typedef ::sick_scan::SickLocColaTelegramMsg_<std::allocator<void> > SickLocColaTelegramMsg;

typedef boost::shared_ptr< ::sick_scan::SickLocColaTelegramMsg > SickLocColaTelegramMsgPtr;
typedef boost::shared_ptr< ::sick_scan::SickLocColaTelegramMsg const> SickLocColaTelegramMsgConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::sick_scan::SickLocColaTelegramMsg_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::sick_scan::SickLocColaTelegramMsg_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::sick_scan::SickLocColaTelegramMsg_<ContainerAllocator1> & lhs, const ::sick_scan::SickLocColaTelegramMsg_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::sick_scan::SickLocColaTelegramMsg_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::sick_scan::SickLocColaTelegramMsg_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::sick_scan::SickLocColaTelegramMsg_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::sick_scan::SickLocColaTelegramMsg_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sick_scan::SickLocColaTelegramMsg_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sick_scan::SickLocColaTelegramMsg_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::sick_scan::SickLocColaTelegramMsg_<ContainerAllocator> >
{
  ...
  static const char* value(const ::sick_scan::SickLocColaTelegramMsg_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xfda058e73f190c37ULL;
  static const uint64_t static_value2 = 0xb2ae74d5f8aa66d7ULL;
};

template<class ContainerAllocator>
struct DataType< ::sick_scan::SickLocColaTelegramMsg_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::sick_scan::SickLocColaTelegramMsg_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::sick_scan::SickLocColaTelegramMsg_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::sick_scan::SickLocColaTelegramMsg_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::sick_scan::SickLocColaTelegramMsg_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
