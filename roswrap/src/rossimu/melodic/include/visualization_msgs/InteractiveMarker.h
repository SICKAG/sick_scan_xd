...
typedef std::shared_ptr< ::visualization_msgs::InteractiveMarker > InteractiveMarkerPtr;
typedef std::shared_ptr< ::visualization_msgs::InteractiveMarker const> InteractiveMarkerConstPtr;
