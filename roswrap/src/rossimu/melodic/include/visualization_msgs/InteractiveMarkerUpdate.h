...
typedef std::shared_ptr< ::visualization_msgs::InteractiveMarkerUpdate > InteractiveMarkerUpdatePtr;
typedef std::shared_ptr< ::visualization_msgs::InteractiveMarkerUpdate const> InteractiveMarkerUpdateConstPtr;
