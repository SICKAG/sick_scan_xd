...
# Start rviz
rosrun rviz rviz -d ./src/sick_scan_xd/test/emulator/config/rviz_emulator_cfg_lms4xxx.rviz --opengl 210 &
sleep 1

# Start sick_scan_xd driver
roslaunch sick_scan_xd sick_lms_4xxx.launch hostname:=127.0.0.1 sw_pll_only_publish:=False &
sleep 1
