REM 
REM Run sick_scan_xd on ROS-2 Windows with timtwo pcapng player
REM 
...
rem start "ros2 sick_generic_caller" ros2 run sick_scan_xd sick_generic_caller ./src/sick_scan_xd/launch/sick_picoscan.launch hostname:=127.0.0.1 udp_receiver_ip:=127.0.0.1 publish_topic:=/cloud publish_topic_all_segments:=/cloud_fullframe publish_frame_id:=world add_transform_xyz_rpy:=0,0,0,0,0,0
start "ros2 sick_scan_xd" ros2 launch sick_scan_xd sick_picoscan.launch.py hostname:=127.0.0.1 udp_receiver_ip:=127.0.0.1 scandataformat:=1
@timeout /t 3

REM 
REM Run pcapng player with picoscan (timtwo) msgpack-data
REM 
