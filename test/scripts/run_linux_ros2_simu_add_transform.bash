...
function run_simu_tim7xx()
{
    ...
    echo -e "\nrun_linux_ros2_simu_add_transform.bash: starting sick_scan sick_generic_caller sick_tim_7xx.launch with additional transform ($tx, $ty, $tz, $roll, $pitch, $yaw)\n"
    start_tim7xx_emulator
    ros2 run sick_scan sick_generic_caller ./src/sick_scan_xd/launch/sick_tim_7xx.launch hostname:=127.0.0.1 port:=2111 add_transform_xyz_rpy:=$tx,$ty,$tz,$roll,$pitch,$yaw &
