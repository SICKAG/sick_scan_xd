...
function run_simu_tim7xx()
{
    ...
    roslaunch sick_scan sick_tim_7xx.launch hostname:=127.0.0.1 add_transform_xyz_rpy:=0,0,0,0,0,0 &
    sleep 5
...
function run_simu_mrs100()
{
    ...
    roslaunch sick_scan sick_scansegment_xd.launch hostname:=127.0.0.1 udp_receiver_ip:=127.0.0.1 add_transform_xyz_rpy:=0,0,0,0,0,0 &
    sleep 5
...
function run_simu_ldmrs()
{
    ...
    roslaunch sick_scan sick_ldmrs.launch hostname:=127.0.0.1 add_transform_xyz_rpy:=0,0,0,0,0,0 &
    sleep 5
...
function run_simu_rms3xx()
{
    ...
    roslaunch sick_scan sick_rms_3xx.launch hostname:=127.0.0.1 add_transform_xyz_rpy:=0,0,0,0,0,0 &
    sleep 5
