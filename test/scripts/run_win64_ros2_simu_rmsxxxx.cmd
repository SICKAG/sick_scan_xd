REM 
REM Run sick_scan on ROS-2 Windows with rms xxxx emulator
REM 
...
REM
REM Run rms1, rms2 emulator and launch sick_scan sick_rms_xxxx.launch (ascii)
REM
...
for %%f in ( 20220316-rms1000-ascii.pcapng.json 20221018_rms_1xxx_ascii_rms2_objects.pcapng.json ) do (
    ...
    @echo Running ros2 launch sick_scan sick_rms_xxxx.launch.py with emulator, scandata file ./src/sick_scan_xd/test/emulator/scandata/%%f
    ...
    start "python ros2 launch sick_rms_xxxx.launch.py" /min cmd /c ros2 launch sick_scan sick_rms_xxxx.launch.py hostname:=127.0.0.1 sw_pll_only_publish:=False
    @timeout /t 15
