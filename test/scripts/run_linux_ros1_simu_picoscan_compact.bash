...
roslaunch sick_scan sick_picoscan.launch hostname:="127.0.0.1" udp_receiver_ip:="127.0.0.1" scandataformat:=2 all_segments_min_deg:=-134 all_segments_max_deg:=135 &
