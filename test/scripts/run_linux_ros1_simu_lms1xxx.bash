...
function run_simu()
{
    ...
    sleep 1 ; roslaunch sick_scan_xd sick_lms_1xxx.launch hostname:=127.0.0.1 sw_pll_only_publish:=False &
...
# Run lms1xxx simulation (firmware version <= 1.x without scan_freq and ang_res configuration, see https://github.com/SICKAG/sick_scan_xd/issues/122):
# 1. Start rviz
