...
python3 ./src/sick_scan_xd/test/python/sopas_json_test_server.py --tcp_port=2112 --json_file=./src/sick_scan_xd/test/emulator/scandata/20240527-LRS36x0.pcapng.json --verbosity=0 &
sleep 1

# Start rviz
rosrun rviz rviz -d ./src/sick_scan_xd/test/emulator/config/rviz_emulator_cfg_lrs36x0.rviz --opengl 210 &
sleep 1

# Start sick_scan_xd driver
roslaunch sick_scan_xd sick_lrs_36x0.launch hostname:=127.0.0.1 sw_pll_only_publish:=False &
sleep 1
